...
import { benefits, defaultCountries, internationalPackages, nightPackages, themes } from "../StaticData"
          ...
          <>
                              ...
                              <AliceCarousel
                                   ...
                                   items={internationalPackages.map((pack, index) =>
                                        <div className="px-2 py-4" key={index}>
                                             <PackageCardType1 image={pack.image} destination={pack.destination} />
                                        </div>
                                   )}
                                   responsive={{
                                        0: { items: 2 },
                    ...
                    <div className="relative rounded shadow-lg overflow-hidden">
                         ...
                         <div className="absolute top-0 left-0 bottom-0 right-0 flex items-center bg-neutral-950/[.30]">
                              <div className="max-w-3xl text-white w-full px-5 py-3">
                                   ...
                                   <Link to={`${prefixAppName}/`} className="bg-white hover:bg-theme text-black hover:text-white px-8 py-3 shadow rounded text-lg font-semibold">Explore</Link>
                              </div>
                         </div>
                    </div>
               </div>
               ...
               <div id="worldwide-unique">
                    <div className="max-w-6xl mx-auto px-4 py-10 border-b border-slate-300">
                         <div className="head-block text-center max-w-4xl mx-auto mb-4">
                              <div className="head text-2xl md:text-3xl font-bold mb-1 md:mb-2">Explore Worldwide Unique Stays.</div>
                              <div className="flex gap-3 overflow-x-auto pb-1home-tab-scroll">
                              ...
                              <AliceCarousel
                                   ...
                                   items={themes.map((theme, index) =>
                                        <div className="px-2 pt-4" key={index}>
                                             <ThemeCard image={theme.image} title={theme.title} />
                                        </div>
                                   )}
                                   responsive={{
                                        0: { items: 2 },
               ...
               <div id="inclusive-packages">
                    <div className="max-w-6xl mx-auto px-4 py-10">
                         <div className="head-block text-center max-w-4xl mx-auto mb-4">
                              <div className="head text-2xl md:text-3xl font-bold mb-1 md:mb-2">All Inclusive Holiday Packages</div>
